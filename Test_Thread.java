...
public class Test_Thread {
	...
	Thread.sleep(10);
	 ...
	 System.out.println("Thread 1: Waiting for lock 2 & 3"); 
	 synchronized (Lock2) {
		 System.out.println("Thread 1: Holding lock1 & 2");
		 synchronized (Lock3) {
		 System.out.println("Thread 1: Holding lock1 & 2 & 3");
		 }}
		 }}}
		 ...
		 Thread.sleep(10);
		  ...
		  System.out.println("Thread 2: Waiting for lock 2 & 3");
		 synchronized (Lock2) {
		 ...
		 System.out.println("Thread 3: Waiting for lock 2 & 3");
		 synchronized (Lock2) {
